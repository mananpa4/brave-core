...
// Confirmation queue and payment token contents for `brave://ads-internals`,
// reported alongside the synchronous `DiagnosticEntryInterface` entries but
// delivered via their own callbacks because reading them requires an async
// database query.
