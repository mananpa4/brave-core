...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_SERVICE_TEST_ADS_SERVICE_MOCK_H_
...
class AdsServiceMock : public AdsService {
 public:
  ...
  MOCK_METHOD(void,
              TestDiagnosticsConditionMatcher,
              (const std::string&,
               const std::string&,
               std::optional<std::string>,
               TestDiagnosticsConditionMatcherCallback));
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_SERVICE_TEST_ADS_SERVICE_MOCK_H_
