...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletTokenAssetId", IDS_BRAVE_WALLET_TOKEN_ASSET_ID},
    {"braveWalletInvalidTokenAssetIdError",
     IDS_BRAVE_WALLET_INVALID_TOKEN_ASSET_ID_ERROR},
    {"braveWalletUnsupportedNetworkForCustomAssetError",
     IDS_BRAVE_WALLET_UNSUPPORTED_NETWORK_FOR_CUSTOM_ASSET_ERROR},
